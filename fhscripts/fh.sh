...
Example of Execute in Local Host:
  $0 -c uname -n
  $0 -s script/test1.sh
  $0 -s script/test1.sh:arg1,arg2 script/test2.sh:arg1,arg2
  $0 -o outputfile -c uname -n
  $0 -o -c uname -n   # default outputfile

Example f Execute in Remote Host:
  $0 -H host1 -c uname -n
  $0 -H host1,host2 -c uname -n
  $0 -H host1,host2 -s script/test1.sh
  $0 -H hostlist -s script/test1.sh
HELP
}
#===========================================================
...
if [ -z "${SCRIPTDIR}/fh.env" ] ; then
    source ${SCRIPTDIR}/fh.env
fi
